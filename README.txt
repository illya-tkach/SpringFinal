...
##########################################################################################
Инстркуция по разворачиванию на локальной машине

1. Скачать исходники
2. Создать в mysql базу с названием springAppGoIT
3. Прописать в resources/application.properties доступ к этой базе
4. Запустить файлы resources/initDB.sql и resources/testDataDB.sql
5. Запускаем приложение.
6. Логин: svitlana.anulich@gmail.com
   пароль: 11111111
